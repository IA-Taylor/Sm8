...
describe('runLookup', () => {
  ...
  it('happy path: model -> part number from manual -> EPAN quote -> task created', async () => {
  ...
  it('when Zunos finds no part, posts a clarification task and stores nothing', async () => {
